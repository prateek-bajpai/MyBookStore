    ...
    <body>
        ...
        <div class="cat_left">
            <%            try {
                    ...
                    ResultSet rs = stmt.executeQuery("select * from b_category");
        ...
        <div class="search_input">
            ...
            <input name="came" placeholder="Enter Category Name" type="text" size="50px;" style="height: 70px; width: 300px;"> </input>
